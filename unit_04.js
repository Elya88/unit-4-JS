...
function f4() {
    ...
    document.querySelector('.out-4').innerHTML = (myCheckBox.checked);
    if (myCheckBox.checked){
    document.querySelector('.out-4').innerHTML = "нажат";
    }
    else {
     document.querySelector('.out-4').innerHTML = "не нажат";
    }
}
...
function f5() {
    ...
    document.querySelector('.out-5').innerHTML = (myCheckBox.checked);
    if (myCheckBox.checked) {
        document.querySelector('.out-5').innerHTML = "task-5";
    }
    else {
...
function f6() {
    ...
    document.querySelector('.out-6').innerHTML = hidden;
...
//если меньше. Для подсчета количества символов в строке используйте length.
...
//innerHTML создает в .out-8 новый div с классом "js2" и текстом 
//"new div". Нажали несколько раз? Создаем несколько раз!
...
function f9() {
    ...
    let myCheckBox = document.querySelector('.r-9');
    document.querySelector('.out-9').innerHTML = (myCheckBox.checked);
    if (myCheckBox.checked){
    document.querySelector('.out-9').innerHTML = "radiobutton";
    }
    else {
     //document.querySelector('.out-9').innerHTML = "не нажат";
    }
}
...
function f11() {
    ...
    let bn = document.querySelector(".i-112");
    let mn = document.querySelector(".i-111");
    bn.value = mn.value;
...
function f12() {
      let r = document.querySelector('.i-12');
      document.querySelector('.out-12').innerHTML = r.value;
}
...
function f13() {
    let s = document.querySelector('.i-13');
    document.querySelector('.out-13').innerHTML = s.value;
}
...
function f14() {
   ...
   document.querySelector('.out-14').innerHTML = t.value;
}
...
function f15() {
   let i5 = document.querySelector('.i-15');
   document.querySelector('.t-15').innerText = i5.value;
   document.querySelector('.out-15').innerHTML = i5.value;
...
function f16() {
   ...
   let p = document.querySelector('.s-16');
   document.querySelector('.out-16').innerHTML = p.value
}
...
function f17() {
    let y = document.querySelector('.s-17');
   document.querySelector('.out-17').innerHTML = y.value
...
function f18() {
    let g = document.querySelector('.s-18');
    let j = document.querySelector('.i-18');
    j.value = g.value;
    // document.querySelector('.i-18').innerText = g.value
...
function f19() {
    let hg = document.querySelector('.i-19');
    document.querySelector('.out-19').innerHTML = hg.value
...
function f20() {
//     let c = document.querySelector('.s-201').addEventListener;
//     let v = document.querySelector('.s-202').selectedIndex;
//     let m = document.querySelector('.s-201').selectedIndex;
//    m = v;

    document.querySelector('.s-201').addEventListener;
    document.querySelector('.s-202').selectedIndex = document.querySelector('.s-201').selectedIndex;
}
